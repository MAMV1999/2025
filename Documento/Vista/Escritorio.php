    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                <?php
                $array = array(
                    "1" => array("nombre" => "REGISTRO DOCUMENTACION", "link" => "reg_documento.php"),
                );
                ?>
                <table class="table">
                    <thead>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                <?php
                $array = array(
                    "1" => array("nombre" => "DOCUMENTOS ENTREGADOS", "link" => "../../Reportes/Vista/DocumentosTodos.php"),
                );
                ?>
                <table class="table">
                    <thead>
        ...
        <p class="d-inline-flex gap-1">
            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">AJUSTES DOCUMENTACION</a>
        </p>
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
                ...
                <!-- CUERPO_INICIO -->
                <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
                    <h5 class="border-bottom pb-2 mb-0"><b>AJUSTES DE DOCUMENTACION</b></h5>
                    <div class="d-flex text-body-secondary pt-3">
                        <br>
                        <?php
                        $array = array(
