    ...
    case 'listar':
        ...
        while ($reg = $rspta->fetch_object()) {
            $data[] = array(
                ...
                "4" => 'S./ ' . $reg->monto,
                "5" => $reg->metodo_pago,
                "6" => '<button class="btn btn-warning btn-sm" onclick="mostrar(' . $reg->id . ')">EDITAR</button> <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">RECIBO</button>
