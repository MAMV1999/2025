    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                $array = array(
                    ...
                    "2" => array("nombre" => "PAGOS MATRICULA", "link" => "Matricula_pago.php"),
                );
                ?>
                <table class="table">
                    <thead>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
            ...
            <div class="d-flex text-body-secondary pt-3">
                ...
                <?php
                $array = array(
                    "1" => array("nombre" => "LISTADO MATRICULAS", "link" => "../../Reportes/Vista/ReciboMatriculaTotal.php"),
                );
                ?>
                <table class="table">
                    <thead>
                ...
                <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
                    ...
                    <div class="d-flex text-body-secondary pt-3">
                        ...
                        $array = array(
                            ...
                            "3" => array("nombre" => "METODO PAGO", "link" => "matricula_metodo_pago.php"),
                        );
                        ?>
                        <table class="table">
                            <thead>
