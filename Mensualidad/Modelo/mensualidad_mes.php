...
class MensualidadMes
{
    ...
    public function guardar($id_institucion_lectivo, $nombre, $descripcion, $observaciones, $estado = 1)
    {
        $sql = "INSERT INTO mensualidad_mes (id_institucion_lectivo, nombre, descripcion, observaciones, estado) 
                VALUES ('$id_institucion_lectivo', '$nombre', '$descripcion', '$observaciones', '$estado')";
        return ejecutarConsulta($sql);
    }

    // Método para editar un mes de mensualidad existente
    public function editar($id, $id_institucion_lectivo, $nombre, $descripcion, $observaciones, $estado)
    {
