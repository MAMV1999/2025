...
switch ($_GET["op"]) {
    case 'guardaryeditar':
        if (empty($id)) {
            $rspta = $usuarioApoderado->guardar($id_apoderado_tipo, $id_documento, $numerodocumento, strtoupper($nombreyapellido), $telefono, $id_sexo, $id_estado_civil, strtolower($usuario), $clave, $observaciones);
            echo $rspta ? "Usuario apoderado registrado correctamente" : "No se pudo registrar el usuario apoderado";
        } else {
            $rspta = $usuarioApoderado->editar($id, $id_apoderado_tipo, $id_documento, $numerodocumento, strtoupper($nombreyapellido), $telefono, $id_sexo, $id_estado_civil, strtolower($usuario), $clave, $observaciones);
